...
const Buildcv = () => {
  return (
    <div>
      <Container maxWidth="lg" sx={{padding: '104px 0px'}}>
        <Box sx={{ flexGrow: 1 }}>
                  ...
                  <Grid container spacing={2}>
                    <Grid item xs={12} md={12} lg={3} xl={3}>
                      <Item className={Styles.build_card_div}>
                        ...
                        <Typography className={Styles.number_para}>
                          <span className={Styles.build_number_design}>1</span>
                        </Typography>
                    ...
                    <Grid item xs={12} md={12} lg={3} xl={3}>
                      <Item className={Styles.build_card_div}>
                        ...
                        <Typography className={Styles.number_para}>
                          <span className={Styles.build_number_design}>2</span>
                        </Typography>
                        <Typography className={Styles.build_card_heading}>
                    ...
                    <Grid item xs={12} md={12} lg={3} xl={3}>
                      <Item className={Styles.build_card_div}>
                        ...
                        <Typography className={Styles.number_para}>
                          <span className={Styles.build_number_design}>3</span>
                        </Typography>
                        <Typography className={Styles.build_card_heading}>
                          Fill in the Blanks
                        </Typography>
                    ...
                    <Grid item xs={12} md={12} lg={3} xl={3}>
                      <Item className={Styles.build_card_div}>
                        ...
                        <Typography className={Styles.number_para}>
                          <span className={Styles.build_number_design}>4</span>
                        </Typography>
                        <Typography className={Styles.build_card_heading}>
                          Hit 'Download!'
                        </Typography>
